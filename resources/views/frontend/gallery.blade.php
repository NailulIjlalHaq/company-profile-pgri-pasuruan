    ...
    <div class="gallery-wrapper">
                        ...
                        <div class="swiper-slide">
                            <div class="swiper__box">
                                <div alt="" class="swiper__box--img">
                                    <div class="swiper__box--img--content" style="background-image: url('{{ $p->file }}')"></div>
                                </div>
        ...
        <div class="gallery-wrapper__content">
            <div class="gallery-container">
                ...
                <input type="hidden" class="descValue{{ $p->id_galleries }}" value="{{ strip_tags($p->description) }}">
