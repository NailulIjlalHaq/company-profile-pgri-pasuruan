                ...
                <div class="gallery-popup">
                    <div class="gallery-popup__wrapper">
                        ...
                        <div class="gallery-popup__wrapper--content">
                            <div class="gallery-popup__wrapper--content__img" style="background: url({{ asset('./frontend/assets/img/juara.jpg') }})"></div>
    ...
    for (let i = 0; i < 8; i++) {
        $('.gallery-container').append(
            `<div class="gallery-container-box">
                    <div class="gallery-container-box-img" style="background: url({{ asset('./frontend/assets/img/juara.jpg') }})"></div>
                </div>`
        )
    }
