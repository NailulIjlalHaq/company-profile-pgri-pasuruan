                    ...
                    <div class="header-dropdown">
                        <div class="header-dropdown-wrapper">
                            <a class="header-dropdown-wrapper__list"
                                href="{{ route('fePko', ['profil' => '5', 'kategori' => '2']) }}">
                                <div class="header-dropdown-wrapper__list--right">
                                    <p>
                                        YPLP Dasmen PGRI
                                    </p>
                            ...
                            <a class="header-dropdown-wrapper__list"
                                href="{{ route('fePko', ['profil' => '6', 'kategori' => '3']) }}">
                            ...
                            <a class="header-dropdown-wrapper__list"
                                href="{{ route('fePko', ['profil' => '7', 'kategori' => '4']) }}">
                            ...
                            <a class="header-dropdown-wrapper__list"
                                href="{{ route('fePko', ['profil' => '8', 'kategori' => '5']) }}">
        ...
        <div style="width: 100%;height: 100%; overflow: auto; display: flex;align-items: center">
            <div class="header-phone-list">
                ...
                <div class="header-phone-list-dropdown">
                    ...
                    <div class="header-phone-list-dropdown-box">
                        <a href="{{ route('fePko', ['profil' => '5', 'kategori' => '2']) }}" class="igtki-link">IGTKI
                            PGRI</a>
                        <a href="{{ route('fePko', ['profil' => '6', 'kategori' => '3']) }}" class="lkbh-link">LKBH -
                            DKGI
                            PGRI</a>
                        <a href="{{ route('fePko', ['profil' => '7', 'kategori' => '4']) }}" class="yplp-link">YPLP
                            Basmen
                            PGRI</a>
                        <a href="{{ route('fePko', ['profil' => '8', 'kategori' => '5']) }}" class="slcc-link">SLCC
                            PGRI</a>
                    </div>
                </div>
