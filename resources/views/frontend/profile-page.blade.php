        ...
        <div class="about__sejarah-wrapper-btn">
            <div class="share-btn">
                <div class="share-btn-wrapper">
                    ...
                    <a class="share-btn-wrapper-btn" href="https://www.facebook.com/sharer/sharer.php?u={{route('feProfil',$page->id_pages)}}">
                        <ion-icon name="logo-facebook"></ion-icon>Facebook
                    </a>
                    <div class="share-btn-wrapper-btn">
                        <ion-icon name="logo-whatsapp"></ion-icon>whatsapp
                    </div>
                    <a class="share-btn-wrapper-btn" href="https://twitter.com/intent/tweet/?text={{$page->title}}&url={{route('feProfil',$page->id_pages)}}">
