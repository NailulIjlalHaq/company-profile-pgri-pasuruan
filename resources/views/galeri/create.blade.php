                    ...
                    <div class="animated fadeInLeft w-100">
                        <div class="card card-primary ">
                            <div class="card-header">
                                <h3 class="card-title"><i class="fas fa-ballot"></i> Input Foto</h3>
                            </div>
                            <!-- /.card-header -->
                            <!-- form start -->
                            <form class="form-horizontal" role="form" action="{{ route('galleries.store') }}"
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-12">
                                            <textarea class="w-100 h-100" name="description" id="description"></textarea>
                                        </div>
                                    </div>
                                </div>
                                <!-- /.card-body -->
