            ...
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                <li class="nav-item {{(request()->segment(2) == 'profil') ? 'menu-is-opening menu-open' : ''}}">
                    ...
                    <ul class="nav nav-treeview">
                        ...
                        <li class="nav-item">
                            <a href="{{ route('profil.index', 5) }}" class="nav-link {{(request()->segment(3) == '4') ? 'active' : ''}}">
                                <i class="far fa-circle nav-icon"></i>
                                <p>YPLP</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('profil.index', 6) }}" class="nav-link {{(request()->segment(3) == '4') ? 'active' : ''}}">
                                <i class="far fa-circle nav-icon"></i>
                                <p>LKBH</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('profil.index', 7) }}" class="nav-link {{(request()->segment(3) == '4') ? 'active' : ''}}">
                                <i class="far fa-circle nav-icon"></i>
                                <p>IGTKI</p>
                            </a>
                        </li>
