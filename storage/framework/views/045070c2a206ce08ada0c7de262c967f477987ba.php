        ...
        <div class="about__sejarah-wrapper-btn">
            <div class="share-btn">
                <div class="share-btn-wrapper">
                    ...
                    <a class="share-btn-wrapper-btn" href="https://www.facebook.com/sharer/sharer.php?u=<?php echo e(route('feProfil',$page->id_pages)); ?>">
                        <ion-icon name="logo-facebook"></ion-icon>Facebook
                    </a>
                    <div class="share-btn-wrapper-btn">
                        <ion-icon name="logo-whatsapp"></ion-icon>whatsapp
                    </div>
                    <a class="share-btn-wrapper-btn" href="https://twitter.com/intent/tweet/?text=<?php echo e($page->title); ?>&url=<?php echo e(route('feProfil',$page->id_pages)); ?>">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('frontend.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/pgripa27/domains/pgripasuruankab.or.id/public_html/profil/resources/views/frontend/profile-page.blade.php ENDPATH**/ ?>