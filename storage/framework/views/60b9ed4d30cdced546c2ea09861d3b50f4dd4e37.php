<?php $__env->startSection('page', $isEdit?'Edit Berita':'Tambah Berita'); ?>
<?php $__env->startSection('content'); ?>
<!-- Content Wrapper. Contains page content -->
<form action="<?php echo e($isEdit?route('berita.update',$post->id_posts):route('berita.store')); ?>" method="POST" enctype="multipart/form-data">
    <?php echo csrf_field(); ?>
    <?php if($isEdit): ?>
            ...
            <div class="container-fluid">
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6 mt-2 text-right">
                        <a class="btn btn-danger mr-2" href="<?php echo e(route('berita.index')); ?>">
                            ...
                            <div class="col-9">
                                <div class="card card-primary ">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            <label>Konten</label>
                                            <textarea type="text" class="form-control <?php echo e($errors->has('konten')?'is-invalid':''); ?>" name="konten" id="konten" row="500"><?php echo e(@old('konten')); ?></textarea>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('backend.master.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/MAMP/htdocs/company-profil/resources/views/backend/berita/form.blade.php ENDPATH**/ ?>