        ...
        <div class="home__sambutan">
            ...
            <div class="home__sambutan--right">
                <div class="card">
                    ...
                    <a class="card__btn" href="<?php echo e(route('fePko')); ?>">Lebih Lanjut
...
<?php echo $__env->make('frontend.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/MAMP/htdocs/company-profil/resources/views/frontend/pko.blade.php ENDPATH**/ ?>