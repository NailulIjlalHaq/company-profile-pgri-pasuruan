<aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                <li class="nav-item <?php echo e((request()->segment(2) == 'profil') ? 'menu-is-opening menu-open' : ''); ?>">
                    ...
                    <ul class="nav nav-treeview">
                        ...
                        <li class="nav-item">
                            <a href="<?php echo e(route('profil.index', 8)); ?>" class="nav-link <?php echo e((request()->segment(3) == '4') ? 'active' : ''); ?>">
                                <i class="far fa-circle nav-icon"></i>
                                <p>SLCC</p>
                            </a>
                        </li>
    ...
    <!-- /.sidebar -->
</aside><?php /**PATH /Applications/MAMP/htdocs/company-profil/resources/views/components/backend/sidebar.blade.php ENDPATH**/ ?>